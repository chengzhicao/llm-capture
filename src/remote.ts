...
const descriptors: TypertRemoteContribution['descriptors'] = [
  {
    ...
    parameters: [{
      ...
      wire: 'request',
      source: 'json',
      codec: { mode: 'strict', typeSymbol: 'dsh-llm-capture#LlmLogListRequest', schema: requestSchema },
    }],
    result: { mode: 'strict', typeSymbol: 'dsh-llm-capture#LlmLogListResult', schema: listResultSchema },
  },
  {
    ...
    parameters: [{
      ...
      wire: 'request',
      source: 'json',
      codec: { mode: 'strict', typeSymbol: 'dsh-llm-capture#LlmLogClearRequest', schema: requestSchema },
    }],
    result: { mode: 'strict', typeSymbol: 'dsh-llm-capture#LlmLogClearResult', schema: clearResultSchema },
  },
]
